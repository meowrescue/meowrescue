...
import { CatExpenseGroup } from "@/hooks/finance/useCatExpenses";

interface CatExpenseBreakdownProps {
  catExpenses: CatExpenseGroup[] | undefined;
  catExpensesLoading: boolean;
}

const CatExpenseBreakdown: React.FC<CatExpenseBreakdownProps> = ({
  catExpenses,
  catExpensesLoading,
}) => (
...
export default CatExpenseBreakdown;
