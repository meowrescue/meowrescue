    ...
    <Layout>
      ...
      <div className="container mx-auto py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-meow-primary mb-4">Contact Us</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea placeholder="What would you like to ask us?" className="min-h-32" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
          ...
          <div>
            <Card className="bg-meow-primary text-white shadow-lg border-none h-full">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@meowrescue.org" className="text-white/80 hover:text-white">
                      info@meowrescue.org
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:7272570037" className="text-white/80 hover:text-white">
                      (727) 257-0037
                    </a>
                  </div>
                </div>
