...
BEGIN
  ...
  BEGIN
    ...
    IF current_role IN ('authenticator', 'service_role', 'supabase_auth_admin') THEN
...
-- Fix Supabase Auth access to profiles
COMMENT ON TABLE public.profiles IS 'User profile information accessible by Supabase Auth';
